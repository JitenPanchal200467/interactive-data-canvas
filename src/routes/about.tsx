      ...
      >
          ...
          {principles.map((p, i) => {
            ...
            return (
              <Reveal key={i} delay={i * 0.08} type="pop">
                <div className="group h-full rounded-2xl border border-border bg-card p-6 shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:border-primary/60 hover:shadow-[0_16px_36px_rgba(61,219,198,0.14)]">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="grid h-8 w-8 place-items-center rounded-lg bg-primary/10 text-primary border border-primary/20 group-hover:bg-primary group-hover:text-primary-foreground transition-colors">
        ...
        <div className="mt-14 grid gap-8 md:grid-cols-3">
          <Reveal delay={0.1} type="pop" className="md:col-span-2">
            <div className="h-full space-y-5 rounded-2xl border border-border bg-card p-6 sm:p-8 shadow-sm transition-all duration-300 hover:border-primary/40 hover:shadow-[0_16px_36px_rgba(61,219,198,0.1)]">
          ...
          <Reveal delay={0.2} type="pop">
            <aside className="h-full rounded-2xl border border-border bg-card p-6 flex flex-col justify-between shadow-sm transition-all duration-300 hover:border-primary/40 hover:shadow-[0_16px_36px_rgba(61,219,198,0.1)]">
              <div>
        ...
        {/* Live Skill Matrix */}
        <Reveal delay={0.15} type="pop" className="mt-16">
          <div className="mb-6">
