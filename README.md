...
Role:
Expert UI/UX Designer and Frontend Developer specializing in immersive, interactive data science portfolios.

Context:
A data scientist needs a standout, highly engaging portfolio website. The site must move away from static resumes and instead incorporate subtle, clever "gimmicks" or interactive elements that subtly showcase data science concepts (e.g., interactive data visualizations, predictive elements, or terminal-style navigation) while remaining clean, professional, and easy to navigate. It needs sections for experience, projects, certifications, and a dynamic way to display work.
...
**OUTPUT**
A comprehensive, well-structured Markdown document containing the portfolio architecture, UI/UX wireframe descriptions, interactive feature mechanics, and tech stack recommendations.

This project was built with [Lovable](https://lovable.dev).

## Build with Lovable

Continue developing this project in the [Lovable editor](https://lovable.dev/projects/8ee63b50-4ce8-43a9-886d-03692af1b549).
